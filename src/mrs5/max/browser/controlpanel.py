...
DEFAULT_HUB_SERVER = 'https://hub.beta.upc.edu'
...
class MAXUISettingsEditForm(controlpanel.RegistryEditForm):
    ...
    label = _("MAX UI settings")
    description = _("help_maxui_settings_editform",
                    default="Settings related to MAX, including OAuth server "

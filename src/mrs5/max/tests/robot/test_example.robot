...
#
#  $ bin/test -s mrs5.max -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mrs5.max.testing.MRS5_MAX_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mrs5/max/tests/robot/test_example.robot
#
